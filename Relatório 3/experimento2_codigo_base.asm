.data
# completar com Estímulo 2.1 ou Estímulo 2.2
...
# verificação de limite do arranjo
 sltu $t0, $s3, $t2 # i < size     # teste de índice: completar com 1 instrução nativa
 beq $t0, $zero, IndexOutOfBounds  # desvio para mensagem de erro: completar com 1 instrução nativa
# corpo do laço
sll $t1, $s3, 2    
add $t1, $t1, $s6 
