...
_array: .byte 3:4	   # N elementos com o valor 3               [substitua N pelo valor definido no relatório]
...
main:
    ...
    lw 		$a1, _size      	# carrega size em $a1                     [completar com 1 instrução nativa]
    jal 	clear2
    li  	$v0,10
    syscall
...
clear2:     
   ...
   sll 		$t1, $a1, 0             # $t1 <- size*4                           [completar com 1 instrução nativa]
...
loop2:
   ...
   addi 	$t0,$t0,1    		# p = p + ?                               [completar operando faltante]
   j 		loop2
